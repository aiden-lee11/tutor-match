  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <Card className="p-6">
              <div className="flex items-center">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900">Total Tutors</h3>
                  <p className="text-2xl font-bold text-green-600">{stats.tutors_count}</p>
                </div>
              </div>
            </Card>
            <Card className="p-6">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-blue-600">{stats.clients_count}</p>
                </div>
              </div>
            </Card>
            <Card className="p-6">
        ...
        <Card className="mb-8">
          <div className="p-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">Manage Tutors</h2>
            <div className="overflow-x-auto">
              <Table>
                ...
                <tbody>
                  {tutors.map((tutor) => (
                    <tr key={tutor.id} className="border-b border-gray-200">
                      ...
                      <td className="py-3 px-4">
                        {editingTutor === tutor.id ? (
                          <input
                            ...
                            className="w-20 p-2 border rounded bg-white border-gray-300"
                          />
                        ) : (
                          <span className="text-gray-900">${tutor.pay}/hr</span>
                        )}
                      </td>
                      <td className="py-3 px-4">
                    ...
                    <tr key={client.id} className="border-b border-gray-200">
                      ...
                      <td className="py-3 px-4">
                        {editingClient === client.id ? (
                          ...
                          <span className="text-gray-900">${client.budget}/hr</span>
                        )}
                      </td>
                      <td className="py-3 px-4">
                        <div className="flex space-x-2">
