      ...
      default:
        return (
          <div className="home-content max-w-4xl mx-auto text-center py-12">
            ...
            {/* Show personalized content if user is logged in and has completed profile */}
              ...
              <div className="mb-12">
                <div className="bg-blue-50 rounded-lg p-6 mb-8">
                  ...
                  <Button 
                    ...
                    className={userType === 'student' ? 'bg-blue-600 hover:bg-blue-700' : 'bg-green-600 hover:bg-green-700'}
                    size="lg"
                  >
                    Go to My Dashboard
                  </Button>
